    ...
    <section className="mx-9 mt-24 mb-32 xl:mx-16 2xl:mx-44">
      <div>
        ...
        <p className="text-dim-gray mt-8">
          Adipiscing enim eu turpis egestas pretium aenean pharetra. Consectetur
          a erat nam at lectus urna duis. Quam quisque id diam vel quam
          elementum pulvinar etiam non. Enim ut tellus elementum sagittis vitae
          et leo. Lacus sed viverra tellus in hac habitasse platea. In ante
          metus dictum at tempor commodo. Cursus risus at ultrices mi tempus.
        </p>
      </div>
      <div className="mt-16">
