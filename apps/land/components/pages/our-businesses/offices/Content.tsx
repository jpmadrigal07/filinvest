    ...
    <section className="mx-9 mt-24 mb-32 xl:mx-16 2xl:mx-44">
      <div>
        ...
        <p className="text-dim-gray mt-4">
          Filinvest connects corporate clients to the right business environment
          with state-of-the-art office buildings and BPO hubs — from
          PEZA-accredited developments such as PBCom Tower and Northgate
          Cyberzone as preferred locations for outsourcing firms and major
          corporations, to smaller modern office spaces and SOHO units that are
          proving to be the ideal addresses for budding entrepreneurs and
          start-up companies.
        </p>
      </div>
