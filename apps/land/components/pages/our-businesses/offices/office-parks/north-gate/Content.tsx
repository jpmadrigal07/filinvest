        ...
        <div className="divide-gainsboro mx-6 mt-[27rem] divide-y md:mx-16 md:mt-44">
          <div className="py-9">
            ...
            <p className="text-dim-gray mt-6">
              ...
              needs of technology-based companies engaged in BPO, KPO,
              education, software design and multimedia, call centers,
              e-commerce, banking and financial services, and other IT support
              businesses.
            </p>
            <p className="text-dim-gray mt-6">
          ...
          <div className="flex flex-col gap-4 py-9">
            ...
            <p className="text-dim-gray">
              ...
              complete with fountains, ideal for rest and relaxation – all
              within a central plaza
            </p>
            <p className="text-jet mt-4 font-bold">
              A 14-Wheeler Mobile Genset
            </p>
            <p className="text-dim-gray">
              A 14-wheeler mobile genset on standby with a capacity of 1,400
              KVA, which can provide 48 hours of continuous back-up power to
              Northgate buildings
            </p>
