    ...
    <section className="mt-16">
      <div className="flex justify-center gap-16">
        <div className="flex flex-col items-center gap-9">
          <div className="flex items-center justify-center rounded-full bg-white py-24 px-24 shadow-2xl">
      ...
      <div className="mx-3 mt-24 mb-24 flex flex-col gap-9 lg:mx-9 xl:mx-16 2xl:mx-44">
